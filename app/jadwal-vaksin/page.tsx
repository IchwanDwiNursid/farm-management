...
const JadwalVaksin = async () => {
    ...
    const tindakan = await getAllJadwalTindakan()
  ...
  return (
    <>
      <div className="row" style={{ marginTop: 50 }}>
        <div className="col-11 w-xl-50 px-4 table-responsive">
      ...
      <div className='row' style={{ marginTop: 50}}>
        <div className="col-11 w-xl-50 px-4 table-responsive">
          <Link href="/jadwal-tindakan/tambah" className="btn btn-success fw-bold text-light mb-3">
              Tindakan
          </Link>
          <table className="table table-striped table-bordered border-primary">
            <thead className='table-primary border-primary'>
            ...
            <tbody>
              {tindakan.length === 0 ? (
                <tr>
                  <td colSpan={8} className="text-center py-4">
                    <h5 className="mb-0 text-muted">Tidak ada jadwal tindakan</h5>
                  </td>
                </tr>
              ): (
                tindakan.map((item) => (
